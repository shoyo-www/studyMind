        ...
        {!activeDocument ? (
          ...
          <>
            {quiz?.generated_with_model === 'groq-fallback' && (
              <div className="w-full max-w-md mb-4 rounded-2xl border border-sky-100 bg-sky-50 px-4 py-3 text-sm text-sky-700">
                Gemini quota was exhausted, so these flashcards were generated through the backend Groq fallback from your extracted PDF text.
              </div>
            )}
